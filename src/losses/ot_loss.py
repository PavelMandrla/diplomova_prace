...
class OT_Loss(Module):
    ...
    def forward(self, normed_density, unnormed_density, points):
        ...
        #print(len(points), batch_size)
        assert len(points) == batch_size    # TODO -> fix sizes, so it is not fixed to who knows what value
        #print(self.output_size, normed_density.size(2))
